...
function sendMail() {
  ...
  let transactionId = document.getElementById("trasectionId").value;

  backData(email);
  var params = {
    transactionId: document.getElementById("trasectionId").value,
    ...
    correspondence_Address: document.getElementById("correspondence_Address")
      .value,
    correspondence_State: document.getElementById("correspondence_State").value,
    correspondence_District: document.getElementById("correspondence_District")
      .value,
